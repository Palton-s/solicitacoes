...
$string['usuarios_busca_help']  = 'Digite o nome, sobrenome, nome de usuário ou email para buscar. A busca funciona com qualquer parte do nome completo, usuário ou email. Você pode selecionar múltiplos usuários.';

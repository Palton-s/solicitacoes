...
$string['usuarios_busca_help']  = 'Digite o nome, cpf ou e-mail do usuário e selecione da lista de sugestões';
...
$string['error_usuarios_required'] = 'Por favor, informe pelo menos um usuário.';
